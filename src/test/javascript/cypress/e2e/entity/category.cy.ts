...
describe('Category e2e test', () => {
  ...
  const categorySample = { label: 'pendant que' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="label"]`).type('consoler');
      cy.get(`[data-cy="label"]`).should('have.value', 'consoler');

      cy.get(`[data-cy="summary"]`).type('séculaire pour que de peur que');
      cy.get(`[data-cy="summary"]`).should('have.value', 'séculaire pour que de peur que');
