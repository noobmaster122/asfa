...
describe('Payment e2e test', () => {
  ...
  const paymentSample = { paymentDate: '2024-12-12', amount: 14068.86, timeStamp: '2024-12-13T13:17:49.855Z' };
  ...
  describe('new Payment page', () => {
    ...
    it('should create an instance of Payment', () => {
      cy.get(`[data-cy="paymentUID"]`).type('0b2c49e5-a00a-479b-b60e-8a65547a1bb5');
      cy.get(`[data-cy="paymentUID"]`).invoke('val').should('match', new RegExp('0b2c49e5-a00a-479b-b60e-8a65547a1bb5'));

      cy.get(`[data-cy="paymentDate"]`).type('2024-12-13');
      cy.get(`[data-cy="paymentDate"]`).blur();
      cy.get(`[data-cy="paymentDate"]`).should('have.value', '2024-12-13');

      cy.get(`[data-cy="amount"]`).type('7217.85');
      cy.get(`[data-cy="amount"]`).should('have.value', '7217.85');

      cy.get(`[data-cy="timeStamp"]`).type('2024-12-13T04:36');
      cy.get(`[data-cy="timeStamp"]`).blur();
      cy.get(`[data-cy="timeStamp"]`).should('have.value', '2024-12-13T04:36');
