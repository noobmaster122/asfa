...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '48f30401-5b49-441f-b0d7-8af3760ea752' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('665290c8-b9ab-4354-a15d-0de2464b1b56');
      cy.get(`[data-cy="name"]`).should('have.value', '665290c8-b9ab-4354-a15d-0de2464b1b56');
