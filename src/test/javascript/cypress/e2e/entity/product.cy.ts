...
describe('Product e2e test', () => {
  ...
  const productSample = { contractNumber: 'vis-à-vie de grrr détacher', startDate: '2024-12-13', productType: 'VIRTUAL' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="productUID"]`).type('1589a5a0-d588-4b0d-bae5-795cb9acc0f8');
      cy.get(`[data-cy="productUID"]`).invoke('val').should('match', new RegExp('1589a5a0-d588-4b0d-bae5-795cb9acc0f8'));

      cy.get(`[data-cy="contractNumber"]`).type('taper');
      cy.get(`[data-cy="contractNumber"]`).should('have.value', 'taper');

      cy.get(`[data-cy="startDate"]`).type('2024-12-13');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2024-12-13');

      cy.get(`[data-cy="endDate"]`).type('2024-12-13');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2024-12-13');

      cy.get(`[data-cy="summary"]`).type('concurrence crac');
      cy.get(`[data-cy="summary"]`).should('have.value', 'concurrence crac');

      cy.get(`[data-cy="productType"]`).select('VIRTUAL');
