...
class PaymentResourceIT {
    ...
    private static final UUID DEFAULT_PAYMENT_UID = UUID.randomUUID();
    private static final UUID UPDATED_PAYMENT_UID = UUID.randomUUID();
    ...
    public static Payment createEntity() {
        return new Payment()
            .paymentUID(DEFAULT_PAYMENT_UID)
    ...
    public static Payment createUpdatedEntity() {
        return new Payment()
            .paymentUID(UPDATED_PAYMENT_UID)
    ...
    void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.[*].paymentUID").value(hasItem(DEFAULT_PAYMENT_UID.toString())))
    ...
    void getPayment() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.paymentUID").value(DEFAULT_PAYMENT_UID.toString()))
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentDate(UPDATED_PAYMENT_DATE).amount(UPDATED_AMOUNT);
