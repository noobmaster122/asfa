...
import static org.asfa.managerasfa.domain.CategoryAsserts.*;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().label(DEFAULT_LABEL).summary(DEFAULT_SUMMARY);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().label(UPDATED_LABEL).summary(UPDATED_SUMMARY);
    }
    ...
    void putExistingCategory() throws Exception {
        ...
        updatedCategory.label(UPDATED_LABEL).summary(UPDATED_SUMMARY);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.label(UPDATED_LABEL).summary(UPDATED_SUMMARY);
