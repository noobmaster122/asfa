...
class ProductResourceIT {
    ...
    private static final UUID DEFAULT_PRODUCT_UID = UUID.randomUUID();
    private static final UUID UPDATED_PRODUCT_UID = UUID.randomUUID();
    ...
    private static final ProductTypeEnum DEFAULT_PRODUCT_TYPE = ProductTypeEnum.VIRTUAL;
    private static final ProductTypeEnum UPDATED_PRODUCT_TYPE = ProductTypeEnum.REAL;
    ...
    void checkContractNumberIsRequired() throws Exception {
        ...
        // set the field null
        product.setContractNumber(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].productUID").value(hasItem(DEFAULT_PRODUCT_UID.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.productUID").value(DEFAULT_PRODUCT_UID.toString()))
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.endDate(UPDATED_END_DATE).productType(UPDATED_PRODUCT_TYPE);
