...
public class PaymentAsserts {
    ...
    public static void assertPaymentUpdatableFieldsEquals(Payment expected, Payment actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getPaymentUID()).as("check paymentUID").isEqualTo(actual.getPaymentUID()))
    ...
    public static void assertPaymentUpdatableRelationshipsEquals(Payment expected, Payment actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getPaymentmethods()).as("check paymentmethods").isEqualTo(actual.getPaymentmethods()));
    }
}
