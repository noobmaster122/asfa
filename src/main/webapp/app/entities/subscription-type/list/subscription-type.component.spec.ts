...
import { sampleWithRequiredData } from '../subscription-type.test-samples';
...
describe('SubscriptionType Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to subscriptionTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSubscriptionTypeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSubscriptionTypeIdentifier).toHaveBeenCalledWith(entity);
